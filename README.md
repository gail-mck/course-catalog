...
What: An interactive website version of the Madeira course catalog with a drag-and-drop four-year academic planner, built as a Jekyll site (using Ruby) with Jacascript for animation. Students can browse courses by department, see prerequisite and corequisites, track graduation requirements, and map out a plan before meeting with the academic dean.
